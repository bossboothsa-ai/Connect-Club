...
const INITIAL_POSTS: Post[] = [
  ...
  },
  {
    ...
    content:
      "Our most beloved Sunday experience returns! Think amazing brunch, deep soulful sounds, and the best vibes in Cape Town. Limited spots — don't sleep on this one.",
  ...
  },
  {
    ...
    content:
      "Want to come to our exclusive Sauna Rave? Complete this week's challenge and two lucky winners get FREE tickets. Tag us when you're done!",
  ...
  },
  {
    ...
    content:
      "Something very special is happening Friday evening. Stay close to the app — we'll be posting a live location at 6pm. First 30 people there get a very special surprise.",
    authorName: "Connect Club",
...
const INITIAL_EVENTS: Event[] = [
  ...
  },
  {
    ...
    title: "Sauna Rave",
    description:
      "Cape Town's most unique wellness party experience. We take over a private sauna facility and transform it into an intimate rave. Cold plunge, sweat it out, dance, repeat. This is next level self-care meets community.",
    image: "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=800&q=80",
    date: "2026-03-29",
    time: "19:00",
...
const INITIAL_CHALLENGES: Challenge[] = [
  ...
  {
    id: "challenge-2",
    title: "Find Connect Club at Saunders",
    description: "Show up at the right place at the right time",
    prize: "VIP table at next Boogie & Brunch",
    instructions:
      "The Connect Club team will be at Saunders Rock in Bantry Bay between 10am and 11am this Saturday. Show up, scan our QR code, and you're entered to win!",
  ...
  },
  {
    ...
    prize: "2x Yacht Cruise Tickets (worth R2,200)",
    instructions:
...
const INITIAL_MOMENTS: Moment[] = [
  ...
  },
  {
    ...
    caption: "Best brunch in Cape Town",
    authorName: "Priya S.",
    eventTitle: "Boogie & Brunch",
...
const INITIAL_NOTIFICATIONS: Notification[] = [
  {
    ...
    body: "Connect Club just announced Boogie & Brunch on March 22nd. Only 12 spots left!",
  ...
  },
  {
    ...
    type: "update",
    title: "Secret drop this Friday",
    body: "Connect Club posted a teaser — something special is happening. Stay tuned!",
  ...
  },
  {
    ...
    body: "Connect Club's new partner Alchemy Wellness is offering members a special discount.",
