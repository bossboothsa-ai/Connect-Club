...
const SLIDES = [
  {
    ...
    body: "Connect Club is Jenna's digital clubhouse — a space just for members. No noise, no spam, just the good stuff.",
  ...
  },
  {
    ...
    body: "Coffee raves, boat cruises, breathwork brunches — discover and RSVP to Jenna's curated events, all in one place.",
  ...
  },
  {
    ...
    body: "Get instant notifications when Jenna drops something new — a location, an event, a challenge, or a surprise.",
